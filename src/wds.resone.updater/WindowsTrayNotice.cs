...
internal static class WindowsTrayNotice
{
    public static void Show(string title, string message)
    {
        ...
        try
        {
            ...
            var data = new NotifyIconData { size = (uint)Marshal.SizeOf<NotifyIconData>(), window = window, id = 1, flags = 1 | 2 | 4, message = 0x8001, icon = icon, tip = "Resone updater", info = "", title = "" };
