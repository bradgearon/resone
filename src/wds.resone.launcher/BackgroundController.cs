...
internal sealed class BackgroundController(string root,string aiRoot,HttpClient http,CancellationTokenSource shutdown,bool skipServices=false):IDisposable
{
