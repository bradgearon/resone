...
const values={SIGNING_PRIVATE_JWK:JSON.stringify(await crypto.subtle.exportKey('jwk',pair.privateKey)),ADMIN_TOKEN:randomBytes(32).toString('hex'),ISSUANCE_SECRET:randomBytes(32).toString('hex')};
